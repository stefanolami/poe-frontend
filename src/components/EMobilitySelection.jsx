					...
					<div className="flex flex-col items-center justify-center gap-3 mx-auto w-[90%]">
						...
						>
							...
							<div className="w-full">
								...
								<div className="px-5 py-2">
									<span className="mt-3 block text-primary font-bold text-xs">
										Purchase, Operations and/or Maintenance
										of stations
									</span>
									<ul className="space-y-1 mt-3">
						...
						>
							<div className="w-full px-5 py-2 bg-primary text-white font-unna text-base text-balance">
								...
								Financing opportunities in the e-mobility sector
							</div>
						...
						checked={data.chargingStations.includes(item.value)} */
									...
									>
										...
										time-sensitive announcements) on
										European Commission support programme
										for research & innovation & deployment
										investment of e-mobility services
									</label>
								</div>
						...
						>
							<div className="w-full px-5 py-2 bg-primary text-white font-unna text-base text-balance">
								...
								opportunities in the e-mobility sector (non-EU
								administered)
							</div>
						...
						>
							...
							<div className="mt-3 px-5 py-2">
								<span className="text-pretty block">
									All monitoring is furnished in English. The
									reports can be available in the following
									languages with an additional{' '}
							...
							<div className="mt-3 px-5 py-2 flex flex-row justify-between items-start gap-1">
								...
								checked={data.chargingStations.includes(item.value)} */
									...
									<label
										...
										htmlFor="checkbox-report-eu"
									>
										2-hour private seminar with the local
										experts on all questions you have on the
										above.
										<span className="mt-4 block">
											Free of charge if the above purchase
											is above EUR 10,000 / year
										</span>
									</label>
								</div>
								<span className="block text-nowrap">
